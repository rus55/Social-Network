...
export const savePhotoSuccess = (photos: number) => ({type: SAVE_PHOTO_SUCCESS, photos} as const)
...
export const savePhoto = (file:) => async (dispatch: Dispatch) => {
...
export const saveProfile = (profile:) => async (dispatch: Dispatch, getState:) => {
